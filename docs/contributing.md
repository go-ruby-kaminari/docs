...
Contributions are welcome. `go-ruby-kaminari/kaminari` is built to a small set of
...
The library is in [`github.com/go-ruby-kaminari/kaminari`](https://github.com/go-ruby-kaminari/kaminari).
This documentation site is in [`github.com/go-ruby-kaminari/docs`](https://github.com/go-ruby-kaminari/docs).
