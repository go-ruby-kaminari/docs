...
The public API lives at the module root (`github.com/go-ruby-kaminari/kaminari`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `kaminari`, while the surface follows
...
```go
import "github.com/go-ruby-kaminari/kaminari"
```
...
- **[pkg.go.dev/github.com/go-ruby-kaminari/kaminari](https://pkg.go.dev/github.com/go-ruby-kaminari/kaminari)**

The module's [README](https://github.com/go-ruby-kaminari/kaminari#readme) carries worked
